            ...
            <div className="login-data">
                ...
                <div className='input'>
                    ...
                    <form className="form-data-login" onSubmit = {handleSubmit}>
                        ...
                        <input type="text" name="usuario" id="" placeholder='usuario' value={itens?.email || ""} onChange={(e) => setItens({...itens, email:e.target.value})}/>
                        
                        <input type="password" name="password" id="" placeholder='senha' value={itens?.password || ""} onChange={(e) => setItens({...itens, password:e.target.value})}/>
